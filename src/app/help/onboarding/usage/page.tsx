...
export default function OnboardingUsage() {
	return (
		<Content>
			...
			<Body1 as="p" block>
				Go back to the <a href="/">Ficus home page</a> using the "Ficus" link at the top. Click the button that says "
				<strong>Create a pull request</strong>". That's it! When it's done, it will give you a link to the pull request that it
				created with your changes. The engineers who manage that repo will be notified that there are new changes to review.
			</Body1>
			<Title2 as="h2" block>
